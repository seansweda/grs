...
void player::move(char* str)
{
int i;

for (i=0; i<2; i++) pos[i]=*str+i;
}

void player::sout(FILE *fp)
{
fprintf(fp,"%-9s%-5s%-5s%-17s%3d%3d%3d%3d%3d%3d%3d%3d%3d%3d%3d%3d%3d",
...
void player::new_pos(char *newpos)
{
